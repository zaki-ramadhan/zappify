...
const Header = () => {
    return (
        <header className="grid grid-cols-2 gap-10">
            ...
            <motion.p variants={fadeIn("left", {motionDelay : 200})} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.5}}  className="text-slate-500 mt-1 max-w-[25rem] place-self-start">The modern labor market dictates its own terms. Today, to be a competitive specialist requires more than professional skills.</motion.p>
        </header>
    )
}
