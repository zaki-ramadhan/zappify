...
const Form = (props) => {
  ...
  return (
    <motion.form variants={fadeIn("up", 300)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} onSubmit={handleSubmit} className={`max-w-lg mx-auto ${isLogin ? 'mt-[7rem]' : 'mt-[5rem]'} p-8 border  border-slate-200/70 dark:border-slate-500 transition-colors duration-500 bg-white/10 backdrop-blur-md rounded-xl shadow-lg`}>
