  ...
  return (
    ...
    <Header darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
      <section className={`-z-50`}>
        <div className="py-1 px-4 mx-auto flex flex-col items-center justify-center max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <motion.button variants={fadeIn("up", { motionDelay: 800 })} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }}>
              <Link to="/" className="inline-flex dark:textslate-700 text-white bg-[#95c681] hover:bg-[#86b274] focus:ring-4 focus:outline-none focus:ring-[#95c681] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-[#95c681] my-4">
                Back to Homepage
              </Link>
            </motion.button>
          </div>
