  ...
  return (
    <section className="px-20 mt-10 min-h-screen grid grid-flow-col grid-cols-9 grid-rows-22 gap-3">
      ...
      <motion.div variants={fadeIn("up", {motionDelay : 200})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
        <div className="bg-gradient-to-t from-slate-800/20 to-slate-800/5 row-span-5 rounded-lg"></div>
        <Card source={image1} backfaceText = {"Cybersecurity Sentinel"} opacity={'opacity-60'}/>
        
        <figure className="flip-card relative w-full h-full group perspective-[1000px] row-span-11 grid grid-rows-subgrid before:content-[''] before:absolute before:-bottom-6 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
            <div className='flip-card-content__wrp w-full h-full row-start-1 row-span-6 transition-all duration-300 [transform-style:preserve-3d] group-hover:rotate-y-180'>
      ...
      <motion.div variants={fadeIn("down", {motionDelay : 350})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
        <div className="bg-gradient-to-t from-slate-800/20 to-slate-800/5 row-span-3 rounded-lg"></div>
        <Card source={image3} backfaceText = {"Sustainable Architecture Guru"} opacity={'opacity-70'}/>
        <figure className="relative row-span-11 grid grid-rows-subgrid before:content-[''] before:absolute before:-bottom-6 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
      ...
      <div className="bg-gradient-to-t from-slate-800/20 to-slate-800/5 row-span-5 rounded-lg"></div>
        <div className="relative row-span-17 grid grid-rows-subgrid before:content-[''] before:absolute before:bottom-14 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
      ...
      {/* 4 */}
        <motion.div variants={fadeIn("down", {motionDelay : 650})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
            <div className="bg-gradient-to-t from-slate-800/20 to-slate-800/5 row-span-3 rounded-lg"></div>
            <div className="relative row-span-19 grid grid-rows-subgrid before:content-[''] before:absolute before:bottom-20 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
        ...
        <motion.div variants={fadeIn("up", {motionDelay : 800})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
            <div className="bg-gradient-to-t from-slate-800/20 to-slate-800/5 row-span-5 rounded-lg"></div>
            <div className="relative row-span-17 grid grid-rows-subgrid before:content-[''] before:absolute before:bottom-12 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
      ...
      <motion.div variants={fadeIn("down", {motionDelay : 650})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
        ...
        <motion.div variants={fadeIn("down", {motionDelay : 350})} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0 }} className='row_wrapper grid grid-rows-subgrid row-span-22'>
            ...
            <div className="relative row-span-11 grid grid-rows-subgrid before:content-[''] before:absolute before:-bottom-6 before:left-1/2 before:translate-x-1/2 before:w-[.8px] before:h-1/2 before:bg-gradient-to-b before:from-slate-800/40 before:to-slate-700/0 before:-z-20">
